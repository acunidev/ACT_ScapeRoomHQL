package com.example.scaperoomhql.model;
...
public class ExamenEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (idExamen != that.idExamen)
            return false;
        if (fecha != null ? !fecha.equals(that.fecha) : that.fecha != null)
            return false;
        if (nota != null ? !nota.equals(that.nota) : that.nota != null)
            return false;
        if (idAlumno != null ? !idAlumno.equals(that.idAlumno) : that.idAlumno != null)
            return false;
        if (idModul != null ? !idModul.equals(that.idModul) : that.idModul != null)
            return false;
