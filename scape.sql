...
/*!40000 ALTER TABLE `Alumno`
    DISABLE KEYS */;
INSERT INTO `Alumno`
VALUES (1, 'G贸mez Blas', 24, 'Pedro', _binary '\0'),
       (2, 'Pons Pont', 20, 'Pere', _binary '\0'),
       (3, 'Bo Pla', 21, 'Ana', _binary '\0'),
       (4, 'Mart铆nez Garcia', 24, 'Pedro', _binary '\0'),
       (5, 'Gimeno Pons', 19, 'Saul', _binary ' '),
       (6, 'Zaragoza Vila', 24, 'Alexia', _binary ' ');
/*!40000 ALTER TABLE `Alumno`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `Examen`
    DISABLE KEYS */;
INSERT INTO `Examen`
VALUES (1, '2022-01-30 06:13:12', 7.45, 2, 1),
